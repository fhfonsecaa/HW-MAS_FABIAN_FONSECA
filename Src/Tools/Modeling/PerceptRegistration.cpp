...
int PerceptRegistration::registerPoses(std::vector<RegisteredPose>& poses) //VINCENZO
{
...
int PerceptRegistration::registerPose(std::vector<RegisteredPose>& poses, const FieldFeature& feature) //VINCENZO
{
  if(feature.isValid)
  {
...
int PerceptRegistration::registerLandmarks(std::vector<RegisteredLandmark>& landmarks)//VINCENZO
{
...
int PerceptRegistration::registerLines(std::vector<RegisteredLine> &lines) //VINCENZO
{
