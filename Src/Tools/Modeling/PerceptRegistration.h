...
//  std::vector<RegisteredLine, Eigen::aligned_allocator<RegisteredLine> >     lines; //  VINCENZO
  std::vector<RegisteredLandmark> landmarks;
//  std::vector<RegisteredLandmark, Eigen::aligned_allocator<RegisteredLandmark> >     landmarks; // VINCENZO
  std::vector<RegisteredPose>     poses;
//  std::vector<RegisteredPose, Eigen::aligned_allocator<RegisteredPose> >     poses; // VINCENZO
...
//  std::vector<FieldLine, Eigen::aligned_allocator<FieldLine> > verticalFieldLines; // VINCENO
  std::vector<FieldLine> horizontalFieldLines; /**< Relevant field lines  */
//  std::vector<FieldLine, Eigen::aligned_allocator<FieldLine> > horizontalFieldLines; //VINCENZO
...
//  std::vector<Matrix2f, Eigen::aligned_allocator<Matrix2f> > lineCovariances; // VINCENZO
  std::vector<Matrix2f> intersectionCovariances;
//  std::vector<Matrix2f, Eigen::aligned_allocator<Matrix2f> > intersectionCovariances; // Vincenzo
  ...
  //int registerLines(std::vector<RegisteredLine, Eigen::aligned_allocator<RegisteredLine> > &lines);
  int registerLines(std::vector<RegisteredLine> &lines);

  int registerLandmarks(std::vector<RegisteredLandmark>& landmarks);
//  int registerLandmarks(std::vector<RegisteredLandmark, Eigen::aligned_allocator<RegisteredLandmark> >& landmarks); //VINCENZO


  int registerPoses(std::vector<RegisteredPose>& poses);
//  int registerPoses(std::vector<RegisteredPose, Eigen::aligned_allocator<RegisteredPose> >& poses); //VINCENZO

  int registerPose(std::vector<RegisteredPose>& poses, const FieldFeature& feature);
//  int registerPose(std::vector<RegisteredPose, Eigen::aligned_allocator<RegisteredPose> >& poses, const FieldFeature& feature);  //VINCENZO
