...
void MotionUtilities::sit(JointRequest& output)
{
  ...
  output.angles[Joints::lKneePitch] = 124_deg;
  output.angles[Joints::rKneePitch] = 124_deg;
  output.angles[Joints::lHipPitch] = -50_deg;
  output.angles[Joints::rHipPitch] = -50_deg;
  output.angles[Joints::lHipRoll] = 0_deg;
  output.angles[Joints::rHipRoll] = 0_deg;
  output.angles[Joints::lAnklePitch] = -67.8_deg;
  output.angles[Joints::rAnklePitch] = -67.8_deg;
  output.angles[Joints::lAnkleRoll] = 0_deg;
  output.angles[Joints::rAnkleRoll] = 0_deg;
}
