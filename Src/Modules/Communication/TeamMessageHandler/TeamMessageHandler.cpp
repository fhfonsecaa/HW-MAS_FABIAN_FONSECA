...
#define SEND_PARTICLE(particle) \
  ...
  SEND_PARTICLE(UtilityShare);
  SEND_PARTICLE(PassShare);
  SEND_PARTICLE(RoleAndContext);
  SEND_PARTICLE(ShareMessage);
...
void TeamMessageHandler::parseMessageIntoBMate(Teammate& currentTeammate)
{
  ...
  RECEIVE_PARTICLE(UtilityShare);
  RECEIVE_PARTICLE(PassShare);
